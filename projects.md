...
These are flows that are typically advection-dominated and exhibit travelling-wave-like behavior (e.g., jets and mixing layers), and it is well known that these features pose a significant problem for most classes of model reduction techniques.
